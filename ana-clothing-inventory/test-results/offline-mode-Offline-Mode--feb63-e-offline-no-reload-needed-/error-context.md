...
- Name: offline-mode.spec.ts >> Offline Mode >> should navigate client-side while offline (no reload needed)
- Location: tests\e2e\offline-mode.spec.ts:5:3
...
- main:
  ...
  - paragraph: Inventory healthy· Local only
