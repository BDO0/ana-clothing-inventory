...
- Name: inventory-history.spec.ts >> Inventory History >> should load history page
- Location: tests\e2e\inventory-history.spec.ts:5:3
...
- main:
  ...
  - combobox:
    ...
    - option "Return"
    - option "Adjustment"
  - text: Select a product and variant
```
